...
def train_actor_critic(n_steps, run, rho_V, rho_pi, omega, outdir):
    ...
    try:
        ...
        for t in trange(n_steps):
            ...
            next_state = torch.clip(next_state, 0.8 - 20 * 0.234, 0.8 + 20 * 0.234)
...
if __name__ == '__main__':
    ...
    Parallel(n_jobs=len(runs))(delayed(train_actor_critic)(n_steps, run, rho_V, rho_pi, omega, outdir + f'_run{run}') for run in runs)
