...
def train_actor_critic(n_steps, rho_V, rho_pi, omega, eta, kappa, outdir):
    ...
    try:
        ...
        for t in trange(n_steps):
            ...
            actor_loss = -(delta.detach() - eta * critic_loss.detach()) * log_prob
...
if __name__ == '__main__':
    ...
    Parallel(n_jobs=len(runs))(delayed(train_actor_critic)(n_steps, rho_V, rho_pi, omega, eta, kappa, outdir + f'_run{run}') for run in runs)
