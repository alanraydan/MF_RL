...
def train_actor_critic(n_steps, rho_V, rho_pi, omega, A, outdir):
...
if __name__ == '__main__':
    ...
    A = 10_000
    outdir = f'{n_steps}steps_{omega}omega_{A}A'
    Parallel(n_jobs=len(runs))(delayed(train_actor_critic)(n_steps, rho_V, rho_pi, omega, A, outdir + f'_run{run}') for run in runs)
